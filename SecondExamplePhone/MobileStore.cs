using SecondExamplePhone.Binder;
using SecondExamplePhone.Reader;
using SecondExamplePhone.Saver;
using SecondExamplePhone.Validator;

namespace SecondExamplePhone
{
